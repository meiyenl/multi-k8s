...
docker push meiyen88/meiyenl:multi-client:latest
docker push meiyen88/meiyenl:multi-server:latest
docker push meiyen88/meiyenl:multi-worker:latest
docker push meiyen88/meiyenl:multi-client:$SHA
docker push meiyen88/meiyenl:multi-server:$SHA
docker push meiyen88/meiyenl:multi-worker:$SHA
kubectl apply -f k8s
